...
return [
    'modules' => [
        ...
        'Course2Link11_WidgetSample' => 0,
        'Course2Link12_LayoutMove' => 0,
        'Course2Link13_RemoveExample' => 0,
        'Course2Link15_CssJs' => 0,
        'Course2Link22_DependencyInjectionExample' => 0,
        'Course2Link23_InjectablesAnsNoninjectables' => 0,
        'Course2Link24_ReplaceConstructorArguments' => 0,
        'Course2Link25_Interfaces' => 0,
        'Course2Link35_CreatePlugins' => 0,
        'Course2Link36_DiaablePlugin' => 0,
        'Course2Link37_ObserversExample' => 0,
        'Course2Link38_DispatchEventExample' => 0,
        'Course2Link39_DisableEventExample' => 0,
        'Course2Link4_Example' => 0,
        'Course2Link6_DefaultPage' => 0,
        'Course2Link7_LayoutSample' => 0,
        'Course2Link8_LayoutSample' => 0,
        'DependencyInjection_Example' => 1,
        'PayPal_Braintree' => 1,
